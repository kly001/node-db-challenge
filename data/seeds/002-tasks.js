  ...
  return knex('tasks').del()
    .then(function () {
      ...
      return knex('tasks').insert([
        ...
        {task_description: 'Task B needs to be done', project_id:2, completed: false},
        {task_description: 'Task C needs to be done', project_id:3, completed: false},
        {task_description: 'Task D needs to be done', project_id:2, completed: false},
        {task_description: 'Task E needs to be done', project_id:3, completed: false},
        {task_description: 'Task F needs to be done', project_id:1, completed: false},
        {task_description: 'Task G needs to be done', project_id:3, completed: false},
        {task_description: 'Task H needs to be done', project_id:1, completed: false},
